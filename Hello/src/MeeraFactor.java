...
public class MeeraFactor {
    public static void main(String[] args){
        System.out.println(isMeeraFactor(30));
        System.out.println(isMeeraFactor(5));
        System.out.println(isMeeraFactor(6));
    }

    public static int isMeeraFactor(int n){
        int count = 0;
        for(int i = 2; i < n; i++){
            if(n % i == 0){
                count++;
