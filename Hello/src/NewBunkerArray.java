...
public class NewBunkerArray {
    public static void main(String[] args){
        System.out.println(newBunkerArray(new int[] {7,6,10,1}));
        System.out.println(newBunkerArray(new int[] {6, 10, 1}));
    }

    public static int newBunkerArray(int[] arr){
