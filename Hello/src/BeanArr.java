// A Bean array is defined to be an array where for every value n in the array, there is also an element n-1 or n+1 in the
// array.
...
public class BeanArr {
    public static void main(String[] args){
        System.out.println(beanAr(new int[] {2, 10, 9, 3}));
        System.out.println(beanAr(new int[] {2, 2, 3, 3, 3}));
        System.out.println(beanAr(new int[] {1, 1, 1, 2, 1, 1}));
        System.out.println(beanAr(new int[] {0, -1, 1}));
        System.out.println(beanAr(new int[] {3, 4, 5, 7}));
        System.out.println(beanAr(new int[] {5, 8, 10, 1}));
    }

    public static int beanAr(int[] arr){
        ...
        for(int i = 0; i < arr.length; i++){
            ...
            // System.out.println("arr[i] "+ num + " " + isBean);
            if(isBean == false){
                return 0;
            }
        }
